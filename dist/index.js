...
async function run() {
  try {
    ...
    const project_split = project.split("/");
    const project_number = project_split.pop()
    const project_repository = project_split.pop() || name;
    const project_owner = project_split.pop() || owner;
